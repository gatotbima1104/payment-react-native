export const DonationData = [
  {
    ...
    totalDonation: 548,
    categories: [2, 10],
    desc: "Anatomically modern humans emerged from modern-day Ethiopia and set out for the Near East and elsewhere in the Middle Paleolithic period.[19][20][21][22][23] Southwestern Ethiopia has been proposed as a possible homeland of the Afroasiatic language family.[24] Ethiopia is Africa's oldest independent country and one of the oldest in the world with over 3000 years of history.[25][26] In 980 BC, the Kingdom of D'mt extended its realm over Eritrea and the northern region of Ethiopia, while the Kingdom of Aksum maintained a unified civilization in the region for 900 years. Christianity was embraced by the kingdom in 330,[27] and Islam arrived by the first Hijra in 615.[28] After the collapse of Aksum in 960, the Zagwe dynasty ruled the north-central parts of Ethiopia until being overthrown by Yekuno Amlak in 1270, inaugurating the Ethiopian Empire and the Solomonic dynasty, claimed descent from the biblical Solomon and Queen of Sheba under their son Menelik I. By the 14th century, the empire had grown in prestige through territorial expansion and fighting against adjacent territories; most notably, the Ethiopian–Adal War (1529–1543) contributed to fragmentation of the empire, which ultimately fell under a decentralization known as Zemene Mesafint in the mid-18th century. Emperor Tewodros II ended Zemene Mesafint at the beginning of his reign in 1855, marking the reunification and modernization of Ethiopia.[29]",
    imageUrl:
  ...
  },
  {
    ...
    imageUrl: "https://news.stv.tv/wp-content/uploads/2020/02/pjimage-5-7.jpg",
  },
  {
    id: 4,
